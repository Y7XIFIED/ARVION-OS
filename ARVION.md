# ARVION Project Guide - React Modern Development Guide
...
After completing the user requirements, please update this ARVION.md file to:
...
├── ARVION.md             # Development guide and template documentation
├── arvion_manifest.json       # Project manifest file
